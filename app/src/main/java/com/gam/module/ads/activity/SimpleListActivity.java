...
import com.gam.module.ads.adapter.ListSimpleAdapter;
...
//                setupAdAdapter();
    ...
    private void setupAdAdapter() {
        adAdapter = GamAd.getInstance().getNativeRepeatAdapter(this, idNative, layoutCustomNative, com.ads.control.R.layout.layout_native_medium,
