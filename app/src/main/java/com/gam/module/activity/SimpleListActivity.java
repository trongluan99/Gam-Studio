...
import com.gam.module.adapter.ListSimpleAdapter;
...
public class SimpleListActivity extends AppCompatActivity {
    ...
    GamAdAdapter adAdapter;
    int layoutCustomNative = com.ads.gam.R.layout.custom_native_admod_medium;
    String idNative = "";
    SwipeRefreshLayout swRefresh;
    ListSimpleAdapter originalAdapter;
    RecyclerView recyclerView;
    GamAdPlacer.Listener listener = new GamAdPlacer.Listener() {
        @Override
...
//                setupAdAdapter();
        ...
        if (GamAd.getInstance().getMediationProvider() == GamAdConfig.PROVIDER_ADMOB) {
            layoutCustomNative = com.ads.gam.R.layout.custom_native_admod_medium;
            idNative = getString(R.string.admod_native_id);
        } else {
            layoutCustomNative = com.ads.gam.R.layout.custom_native_max_small;
    ...
    private void setupAdAdapter() {
        adAdapter = GamAd.getInstance().getNativeRepeatAdapter(this, idNative, layoutCustomNative, com.ads.gam.R.layout.layout_native_medium,
