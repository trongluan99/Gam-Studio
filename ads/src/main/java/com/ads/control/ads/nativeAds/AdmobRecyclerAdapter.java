...
public class AdmobRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final GamAdPlacerSettings settings;

    private RecyclerView.Adapter adapterOriginal;
    private Activity activity;
    private GamAdPlacer adPlacer;
    private AdapterDataObserver adapterDataObserver = new AdapterDataObserver();

    public AdmobRecyclerAdapter(GamAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
        this.adapterOriginal = adapterOriginal;
        this.registerAdapterDataObserver(adapterDataObserver);
        this.activity = activity;
        this.settings = settings;
        adPlacer = new GamAdPlacer(settings, adapterOriginal, activity);
    }
    ...
    private class GamViewHolder extends RecyclerView.ViewHolder {
        public GamViewHolder(@NonNull View itemView) {
            super(itemView);
        }
