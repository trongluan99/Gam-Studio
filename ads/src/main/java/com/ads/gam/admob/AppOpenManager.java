                    ...
                    public void onAdLoaded(AppOpenAd ad) {
                        ...
                        if (!isSplash) {
                            ...
                            AppOpenManager.this.appResumeAd.setOnPaidEventListener(adValue -> {
                                ...
                                GamLogEventManager.logPaidAdjustWithToken(adValue, ad.getAdUnitId(), GamAdConfig.ADJUST_TOKEN_TIKTOK);
                            });
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh1.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            GamLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh1.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh2.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            GamLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh2.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh3.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            GamLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh3.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashNormal.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            GamLogEventManager.logClickAdsEvent(activity, mOpenSplashNormal.getAdUnitId());
                            adCallback.onAdClicked();
