...
public class GamAdPlacerSettings {
    ...
    private GamAdPlacer.Listener listener;
    public GamAdPlacerSettings(String adUnitId, int layoutCustomAd, int layoutPlaceHolderAd) {
        this.adUnitId = adUnitId;
        this.layoutCustomAd = layoutCustomAd;
        this.layoutAdPlaceHolder = layoutPlaceHolderAd;
    }
    public GamAdPlacerSettings(int layoutCustomAd, int layoutPlaceHolderAd) {
        this.adUnitId = adUnitId;
        this.layoutCustomAd = layoutCustomAd;
        this.layoutAdPlaceHolder = layoutPlaceHolderAd;
    }
    ...
    public GamAdPlacer.Listener getListener() {
        return listener;
    }

    public void setListener(GamAdPlacer.Listener listener) {
