...
public class GamAppsflyer {
    private static final String TAG = "GamAppsflyer";
    private Context context;
    private static GamAppsflyer GamAppsflyer;
    public static boolean enableAppsflyer = false;

    public GamAppsflyer() {
    }

    public static GamAppsflyer getInstance(){
        if (GamAppsflyer ==null)
            GamAppsflyer = new GamAppsflyer();
        return GamAppsflyer;
    }
