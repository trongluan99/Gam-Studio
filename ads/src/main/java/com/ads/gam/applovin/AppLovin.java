...
//    private final Map<String, AppOpenAd> appOpenAdMap = new HashMap<>();
    ...
    public void loadSplashInterstitialAds(final Context context, String id, long timeOut, long timeDelay, AppLovinCallback adListener) {
        ...
        interstitialSplash.setListener(new MaxAdListener() {
            ...
            public void onAdClicked(MaxAd ad) {
                ...
                GamLogEventManager.logClickAdsEvent(context, ad.getAdUnitId());
            }
    ...
    public void onShowSplash(Activity activity, AppLovinCallback adListener) {
        ...
        interstitialSplash.setListener(new MaxAdListener() {
            ...
            @Override
            public void onAdClicked(MaxAd ad) {
                GamLogEventManager.logClickAdsEvent(context, interstitialSplash.getAdUnitId());
                if (adListener != null) {
                    adListener.onAdClicked();
                }
                if (disableAdResumeWhenClickAds)
    ...
    public MaxRecyclerAdapter getNativeRepeatAdapter(Activity activity, String id, int layoutCustomNative, RecyclerView.Adapter originalAdapter,
        ...
        MaxNativeAdViewBinder binder = new MaxNativeAdViewBinder.Builder(layoutCustomNative)
                .setTitleTextViewId(com.ads.gam.R.id.ad_headline)
                .setBodyTextViewId(com.ads.gam.R.id.ad_body)
                .setAdvertiserTextViewId(com.ads.gam.R.id.ad_advertiser)
                .setIconImageViewId(com.ads.gam.R.id.ad_app_icon)
                .setMediaContentViewGroupId(com.ads.gam.R.id.ad_media)
                .setOptionsContentViewGroupId(com.ads.gam.R.id.ad_options_view)
                .setCallToActionButtonId(com.ads.gam.R.id.ad_call_to_action)
                .build();
